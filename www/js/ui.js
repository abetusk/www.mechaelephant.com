...
function canvasFocus(button_id) {

  if (typeof button_id !== 'undefined') {
    console.log("blurring:", button_id);
    $("#" + button_id).blur();
  } else {
...
$(function() {
  ...
  */
  ...
  var nam = getParameterByName("id");
  if ( nam )
  {
    openGCodeFromPath( '/downloadManager.py?id=' + nam );
  } else {
    //openGCodeFromPath( '/downloadManager.py?id=foo' );
  }
  //openGCodeFromPath( '/downloadManager.py?id=foo' );
